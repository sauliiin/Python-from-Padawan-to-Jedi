print('Faça um programa que leia o nome completo de uma pessoa e mostre o primeiro e o último nome separados')
...
# len de length (comprimento). Estuda inglês, Padawan!
